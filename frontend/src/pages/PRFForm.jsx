...
export default function PRFForm() {
  ...
  const [fields, setFields] = useState(() => {
    ...
    const saved = localStorage.getItem('prfLayoutClean');
  ...
  const [checklist, setChecklist] = useState([
    { id: 1, text: 'Quotation Summary Verified', checked: false },
    { id: 2, text: 'Budget Availability Confirmed', checked: false },
    { id: 3, text: 'Items & Specifications Validated', checked: false },
    { id: 4, text: 'Attachments (Canvass) Checked', checked: false }
  ]);
